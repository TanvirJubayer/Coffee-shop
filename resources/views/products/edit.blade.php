<x-layouts.app-layout>
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <fieldset class="name">
                    ...
                    <fieldset class="category">
                     ...
                     <div class="cols gap22">
                        <fieldset class="price">
                            ...
                            <input class="mb-10" type="number" step="0.01" placeholder="Enter price" name="price" tabindex="0" value="{{ $product->price }}" aria-required="true" required="">
                        </fieldset>
                        <fieldset class="cost">
                            <div class="body-title mb-10">Cost (Optional)</div>
                            <input class="mb-10" type="number" step="0.01" placeholder="Enter cost" name="cost" tabindex="0" value="{{ $product->cost }}">
                        </fieldset>
                    </div>
