                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap14">
                                                ...
                                                <div>
                                                    ...
                                                    <h4>{{ number_format($totalVisitor) }}</h4>
                                                </div>
                                            </div>
                                            <div class="box-icon-trending up">
                                                <i class="icon-trending-up"></i>
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <ul class="flex flex-column justify-between gap10 h-full">
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('images') }}/country/6.png" alt="">
                                                </div>
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('images') }}/country/7.png" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('images') }}/country/8.png" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('images') }}/country/9.png" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('images') }}/country/10.png" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('images') }}/country/11.png" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-best-shop-sellers">
                                            ...
                                            <ul class="flex flex-column gap18">
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/shop/1.png" alt="">
                                                    </div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/shop/3.png" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/shop/4.png" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/shop/5.png" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/shop/6.png" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/shop/7.png" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
