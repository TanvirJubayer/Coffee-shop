                            ...
                            <div class="header-left">
                                <a href="{{ route('admin.dashboard') }}">
                                    <img class="" id="logo_header_mobile" alt=""
                                        ...
                                        data-dark="{{ asset('images') }}/logo/logo-dark.png" data-width="154px"
                                        data-height="52px" data-retina="{{ asset('images') }}/logo/logo@2x.png">
                                </a>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/avatar/user-11.png"
                                                            alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/avatar/user-12.png"
                                                            alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{ asset('images') }}/avatar/user-13.png"
                                                            alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-1.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-2.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-3.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-4.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-5.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-6.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-7.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-8.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('images') }}/apps/item-9.png"
                                                                alt="">
                                                        </div>
                                                        <a href="#">
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Mr. Jashim</span>
